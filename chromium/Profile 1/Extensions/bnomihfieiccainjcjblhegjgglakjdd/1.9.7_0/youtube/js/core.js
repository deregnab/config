...
chrome.storage.local.get(function(data) {
  ...
  injectScript([
    ...
    'objectDefineProperties();',
    'function modRemoveAttribute(original) { return function () { if (arguments[0] == "dark" && settings.default_dark_theme == "true") { return false; } return original.apply(this, arguments); } } document.documentElement.removeAttribute = modRemoveAttribute(document.documentElement.removeAttribute);',
